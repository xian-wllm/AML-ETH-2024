"""
DEPRECATED:
R2 = 0.6107815299756704 0.024070525381628866
MAE = -4.5719871040658715 0.21200853700826683
"""
...
def main():
    ...
    #mean_score = -score.mean()  # Convert to positive MAE
    #std_score = score.std()
    #print(f"Mean MAE: {mean_score:.4f}, Std: {std_score:.4f}")
...
def create_submission(model, X_train, y_train, X_test):
    ...
    np.savetxt("submission_6_git_lof_XGBRegressor.csv", pred, delimiter=",", header="id,y", comments="", fmt=["%d", "%d"])
